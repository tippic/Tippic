...
# XLS report
        custom_value = {}
        label_lists = ['FECHA', 'EMPRESA', 'MOVIMIENTO', 'PRODUCTO','LOTE', 'CANTIDAD', 'UNIDAD']
        ...
        for values in order:
            item = [
                    str(values.date or ''),
                    str(values.move_id.partner_id.parent_id.name or values.move_id.partner_id.name or values.move_id.picking_id.partner_id.parent_id.name or values.move_id.picking_id.partner_id.name or ''),
